...
interface BirthdayDao {
    ...
    // FEAT-12: a dedicated query rather than routing through updateBirthday — a star tap
    // shouldn't need to round-trip the whole row through Kotlin first.
    @Query("UPDATE birthdays SET isFavorite = :isFavorite WHERE id = :id")
